...
$sqll="update gold_app set GOLD_APP_tit='$app_title',GOLD_APP_ser='$app_serial',GOLD_APP_des='$app_desc',
GOLD_APP_img='$main_name',
GOLD_APP_thumb='$sub_name,'
GOLD_APP_cil='$app_client',
GOLD_APP_re'$regist_day' where GOLD_APP_num=$app_update_num";
// echo $app_title,
// $app_serial,
// $app_client,
// $app_desc,
